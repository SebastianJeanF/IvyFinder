<template>
<div class="custom-shape-divider-bottom-1631323859">
...
<style scoped>
.custom-shape-divider-bottom-1631323859 {
    position: absolute;
    bottom: 0;
    left: 0;
    width: 100%;
...
.custom-shape-divider-bottom-1631323859 svg {
    position: relative;
    display: block;
...
.custom-shape-divider-bottom-1631323859 .shape-fill {
    fill: #FFFFFF;
}
